...
export const providerPresets: ProviderPreset[] = [
  ...
  },
  {
    ...
    settingsConfig: {
      env: {
        ANTHROPIC_BASE_URL: "https://joycode-api.jd.com",
        ANTHROPIC_AUTH_TOKEN: "sk-joycode-proxy",
        ...
        ANTHROPIC_DEFAULT_OPUS_MODEL: "Claude-Opus-4.6-hq",
      },
    },
    category: "third_party",
    apiFormat: "anthropic",
    endpointCandidates: ["https://joycode-api.jd.com"],
    modelsUrl: "https://joycode-api.jd.com/api/saas/model-runtime/v1/models",
    icon: "anthropic",
  },
  {
    name: "Shengsuanyun",
  ...
  },
  {
    ...
    settingsConfig: {
      env: {
        ...
        ANTHROPIC_DEFAULT_HAIKU_MODEL: "MODEL_GPT_5_NANO",
        ANTHROPIC_DEFAULT_HAIKU_MODEL_NAME: "DeepSeek V3.2",
        ...
        models: [
          {
            ...
            apiKey: "sk-apbaxuqgkkfkhkkqhihwctdvffjqublsqnlwnxbrdnpbekle",
            authHeader: "bearer",
